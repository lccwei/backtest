    ...
    static QPainterPath generateSmoothCurve(const QVector<QPointF>& points) {
        ...
        while (i < pointSize) {
            if (qIsNaN(points.at(i).y()) || qIsNaN(points.at(i).x()) || qIsInf(points.at(i).y())) {
                QVector<QPointF> lineData(QVector<QPointF>(points.constBegin() + i - segmentStart,
                                                           points.constBegin() + segmentStart));
        ...
        //     QVector<QPointF> lineData(QVector<QPointF>(points.constBegin() + segmentStart,
        //     points.constEnd()));
        QVector<QPointF> lineData(i - segmentStart);
        std::copy(points.constBegin() + segmentStart,
                  points.constBegin() + i - segmentStart,
